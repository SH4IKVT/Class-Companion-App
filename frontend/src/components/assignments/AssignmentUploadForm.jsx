...
import {FiFileText, FiBookOpen, FiCalendar, FiUpload, FiPaperclip} from "react-icons/fi";

export default function AssignmentUploadForm({ onUpload }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <FiCalendar
          className="absolute right-4 top-4 text-[#6B73FF] text-xl cursor-pointer"
          onClick={() => {
             {/*ndate picker */}
      ...
      <button
        ...
        className="
          ...
          bg-gradient-to-r from-[#6B73FF] to-[#000DFF]
